...
NUM_SHARDS = 8          # Number of parquet files to download
...
train_dataset.save_to_disk(os.path.join(SAVE_DIR,"ROBO2VLM_train_10k"))
test_dataset.save_to_disk(os.path.join(SAVE_DIR,"ROBO2VLM_test_2k"))
